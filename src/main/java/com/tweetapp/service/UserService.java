...
public class UserService  {
	...
	public ResponseEntity<Envelope<String>> forgotPassword(String userName, String password) {
		...
		/*
		 * userRepository.findByEmailIdName(userName); Query query = new Query();
		...
		User presentUser = findByEmailIdName.get();
		presentUser.setPassword(TweetConstant.PASSWORD);
		if(presentUser!=null)
	...
	public ResponseEntity<Envelope<User>> username(String userName) {
		...
		Optional<User> userPresent = userRepository.findByFirstName(userName);
